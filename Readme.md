Hi! My name Andrew. I present to you my own implementation of the test task. To start the work, run Start_SQL.sql . After creating the database, you can run the application.
